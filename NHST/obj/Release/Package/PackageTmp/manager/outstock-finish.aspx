                                        ...
                                        <div class="col s12">
                                            <div class="row">
                                              ...
                                              <%--  <div class="input-field col s12 m6">
                                                    <p style="font-size: 16px; font-weight: bold;">Tổng số cân nặng: <span style="color: #F64302;">
                                                        <asp:Literal runat="server" ID="ltrTotalWeight"></asp:Literal>
                                                        Kg</span></p>
                                                </div>--%>
                                                <div class="input-field col s12 m6">
                                                    <p style="font-size: 16px; font-weight: bold;">Tiền cần thanh toán: <span style="color: #F64302;">

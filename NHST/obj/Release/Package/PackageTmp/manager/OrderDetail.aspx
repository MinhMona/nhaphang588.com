                                    ...
                                    <table class="table   ">
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:DropDownList ID="ddlWarehouseFrom" runat="server" CssClass="form-control" Enabled="false"
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:DropDownList ID="ddlReceivePlace" runat="server" CssClass="form-control" Enabled="false"
                                                        DataValueField="ID" DataTextField="WareHouseName">
                                                    </asp:DropDownList>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:DropDownList ID="ddlShippingType" runat="server" CssClass="form-control" Enabled="false"
                                        ...
                                        <div class="order-row">
                                            ...
                                            <div class="right-content">
                                                <div class="row">
                                                    ...
                                                    <div class="input-field col s12 m6">
                                                        <asp:TextBox runat="server" ID="pWeight" placeholder="0" type="text" data-type="currency" value="0"></asp:TextBox>
                                                        <label>Việt Nam Đồng (VNĐ)</label>
                                                    </div>
                                                </div>
                                            </div>
            ...
            $(document).ready(function () {
                ...
                $('.mvc-list .add-product').on('click', function () {
                    ...
                    var html = ` <tr class="ordercode order-versionnew" data-packageID="0">
                              ...
                              <td><input class="transactionWeight"  data-type="number" value="0"></td>`;
                    html += ` <td><input class="transactionWeight"  data-type="number" value="0"></td>`;
                    html += ` <td><input class="transactionWeight"  data-type="number" value="0"></td>`;
                    html += ` <td><input class="transactionWeight"  data-type="number" value="0 x 0 x 0"></td>`;
                    html += `<td>

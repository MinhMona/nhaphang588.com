                                                ...
                                                <div class="col s12">
                                                    ...
                                                    <div class="donate-guide">
                                                        ...
                                                        <strong>thanh toán</strong> một khoản tiền <strong>đặt
                                                            cọc trước cho NHẬP HÀNG 558 </strong> để chúng tôi thực hiện
                                                        ...
                                                        website đặt hàng Trung Quốc, số tiền này <strong> GoFast thu hộ </strong> cho nhà cung cấp.
                                                        </p>
                                                        <p class="pl-3">
                                                            + <strong>Phí dịch vụ</strong>: là phí khách hàng
                                                        trả cho <strong> NHẬP HÀNG 558 </strong> để tiến hành thu mua theo đơn hàng đã đặt.
                                                        </p>
                                                        ...
                                                        <p class="pl-3">
                                                            + <strong>Văn phòng tại Hà Nội: 7 Ngõ 162 Khương Đình, Khương Hạ, Thanh Xuân, Hà Nội</strong>
                                                        </p>
                                                        <p class="pl-1">2. Chuyển khoản trực tiếp.</p>
                                                        <p class="pl-2">- Nội dung chuyển khoản theo cú pháp:</p>
                                                        <p class="pl-3">+ <strong>NAP USERNAME SĐT</strong></p>

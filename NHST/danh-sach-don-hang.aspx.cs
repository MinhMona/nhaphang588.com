        ...
        public void LoadData()
        {
            ...
            if (obj_user != null)
            {
                ...
                if (tos.Count > 0)
                {
                    ...
                    var totalorderchuagiao = tos.Where(od => od.Status == 2 || od.Status == 4 || od.Status == 5 || od.Status == 6 || od.Status == 7).ToList();
                    ...
                    for (int i = 0; i < acs.Count; i++)
                    {
                        ...
                        if (item.OrderType == 3)
                        {
                            if (item.IsCheckNotiPrice == true)
                            {
                                if (item.Status == 1)
                                {
                                    html.Append("<td class=\"no-wrap\"><span class=\"badge black darken-2 white-text border-radius-2\">Hủy đơn hàng</span></td>");
                                }
                                else
                                {
                                ...
                                if (userwallet >= custDeposit)
                                {
                                    ...
                                    if (st == 1)
                                    {
                                        ...
                                        if (setNoti != null)
                                        {
                                            ...
                                            //                    "Thông báo tại NHẬP HÀNG 558.", "Đơn hàng " + o.ID + " đã được đặt cọc.", "");
                                            //            }
                                            //            catch { }
                                            //        }
                                            //    }
                                        ...
                                        if (setNoti.IsSentEmailAdmin == true)
                                        {
                                            ...
                                            if (admins.Count > 0)
                                            {
                                                foreach (var admin in admins)
                                                {
                                                    ...
                                                    {
                                                        PJUtils.SendMailGmail("monamedia", "uvnajxzzurygsduf", admin.Email,
                                                            "Thông báo tại NHẬP HÀNG 558.", "Đơn hàng " + item.MainOrderID + " đã yêu cầu giao hàng.", "");
                                                    }
                                                    catch { }
                                                }
                                            }
                                                    ...
                                                    if (setNoti.IsSentEmailAdmin == true)
                                                    {
                                                        ...
                                                        if (admins.Count > 0)
                                                        {
                                                            foreach (var admin in admins)
                                                            {
                                                                ...
                                                                {
                                                                    PJUtils.SendMailGmail("monamedia", "uvnajxzzurygsduf", admin.Email,
                                                                        "Thông báo tại NHẬP HÀNG 558.", "Đơn hàng " + o.ID + " đã được thanh toán.", "");
                                                                }
                                                                catch { }
                                                            }
                                                        }

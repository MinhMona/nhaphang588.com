            ...
            if (obj_user != null)
            {
                ...
                if (ts.Count > 0)
                {
                    ...
                    foreach (var t in ts)
                    {
                        ...
                        totalVolume = Convert.ToDouble(t.TotalVolume);
                        ...
                        d.TotalVolume = totalVolume.ToString();
                        d.IntStatus = status;
        ...
        public void pagingall(List<Danhsachorder> acs)
        {
            ...
            if (acs.Count > 0)
            {
                ...
                for (int i = FromRow; i < ToRow + 1; i++)
                {
                    ...
                    html.Append("<td>" + item.TotalVolume + " m3</td>");                   
                            ...
                            if (LeftMoney <= wallet)
                            {
                                ...
                                if (a == 1)
                                {
                                    ...
                                    if (setNoti != null)
                                    {
                                        ...
                                        //                    "Thông báo tại NHẬP HÀNG 558.", "Đơn hàng vận chuyển hộ " + t.ID + " đã được thanh toán.", "");
                                        //            }
                                        //            catch { }
                                        //        }
                                        //    }

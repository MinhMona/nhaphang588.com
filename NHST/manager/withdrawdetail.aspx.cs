                        ...
                        else if (acc.RoleID == 0)
                        {
                            ...
                            if (user_rut != null)
                            {
                                ...
                                if (setNoti != null)
                                {
                                    ...
                                    //            "Thông báo tại NHẬP HÀNG 558.", "Admin đã duyệt lệnh rút tiền của bạn.", "");
                                    //    }
                                    //    catch { }
                                    //}
                                }
                    ...
                    else if (status == 3)
                    {
                        ...
                        if (user_rut != null)
                        {
                            ...
                            if (setNoti != null)
                            {
                                if (setNoti.IsSentNotiUser == true)
                                {
                                    NotificationsController.Inser(user_rut.ID, user_rut.Username, 0, "BQT THUẬN ĐẠT EXPRESS đã hủy lệnh rút tiền của bạn.",
                                ...
                                //    {
                                //        PJUtils.SendMailGmail("monamedia", "uvnajxzzurygsduf", user_rut.Email,
                                //            "Thông báo tại NHẬP HÀNG 558.", "Admin đã hủy lệnh rút tiền của bạn.", "");
                                //    }
                                //    catch { }
                                //}
                            }

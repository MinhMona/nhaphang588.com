                        ...
                        if (ops.Count > 0)
                        {
                            foreach (var o in ops)
                            {
                                ...
                                else
                                {
                                    ...
                                    {
                                        html.Append("<div class=\"responsive-tb package-item\">");
                                        html.Append("<span class=\"owner\">Đơn hàng vận chuyển hộ #" + o.OrderID + "</span>");
                                        //html.Append("   <div class=\"heading\"><h3 class=\"lb\">Đơn hàng VC hộ: #" + o.OrderID + "</h3></div>");
                                    }
                                    else
                                    {
                                        html.Append("<div class=\"responsive-tb package-item\">");
                                        html.Append("<span class=\"owner\">Đơn hàng vận chuyển hộ #" + o.OrderID + "</span>");

...
namespace NHST.manager
{
    public partial class staff_income : System.Web.UI.Page
    {
        ...
        public void LoadData()
        {
            ...
            TotalPaid = StaffIncomeController.GetTotalPrice(2, a.ID, "TotalPriceReceive", search, fd, td);
            TotalNotPaid = StaffIncomeController.GetTotalPrice(1, a.ID, "TotalPriceReceive", search, fd, td);

...
namespace NHST.manager
{
    public partial class OrderDetail : System.Web.UI.Page
    {
        ...
        public void LoadDDL()
        {
            ...
            var warehousefrom = WarehouseFromController.GetAllWithIsHiddenOrder(false);
                    ...
                    if (obj_user != null)
                    {
                        ...
                        else if (RoleID == 4)
                        {
                            ...
                            else if (o.Status >= 4 && o.Status < 6)
                            {
                                ...
                                ddlStatus.Items.Add(new ListItem("Đã mua hàng", "4"));
                                ddlStatus.Items.Add(new ListItem("Shop đã phát hàng", "5"));
                                ddlStatus.Items.Add(new ListItem("Hàng về kho TQ", "6"));
                            }
                            else if (o.Status >= 6)
                            {
                        ...
                        if (smallpackages.Count > 0)
                        {
                            foreach (var s in smallpackages)
                            {
                                ...
                                if (pDai > 0 && pRong > 0 && pCao > 0)
                                    quidoi = Math.Round((pDai * pRong * pCao) / 6000, 5);

                                double cantinhtien = quidoi;
                                if (Convert.ToDouble(s.Weight) > quidoi)
                                    cantinhtien = Math.Round(Convert.ToDouble(s.Weight), 5);
                    ...
                    if (o != null)
                    {
                        ...
                        if (ischeckmvd == true)
                        {
                            ...
                            else
                            {
                                ...
                                double FeeShipCYN = Math.Round(Convert.ToDouble(pCNShipFeeNDT.Text), 0);

                                TotalPriceReal = Math.Round(TotalPriceRealCYN * CurrentCNYVN, 0);
                                FeeShipCN = Math.Round(FeeShipCYN * CurrentCNYVN, 0);
                            ...
                            if (!string.IsNullOrEmpty(comment))
                            {
                                ...
                                if (type == 1)
                                {
                                    if (setNoti != null)
                                    {
                                        ...
                                        //        "Thông báo tại NHẬP HÀNG 558.", "Đã có đánh giá mới cho đơn hàng #" + id + " của bạn. CLick vào để xem", "");
                                        //    }
                                        //    catch { }
                                        //}
                                    }

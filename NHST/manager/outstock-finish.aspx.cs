    ...
    public partial class outstock_finish : System.Web.UI.Page
    {
                                    ...
                                    if (packsmain.Count > 0)
                                    {
                                        foreach (var p in packsmain)
                                        {
                                            ...
                                            if (sm != null)
                                            {
                                                ...
                                                double weightCN = Math.Round(Convert.ToDouble(sm.Weight), 5);
                                                //double weight = 0;                                                
                                                double weightKT = 0;
                                                double dai = 0;
                                                double rong = 0;
                                                ...
                                                if (dai > 0 && rong > 0 && cao > 0)
                                                    weightKT = Math.Round(dai * rong * cao / 6000, 5);
                                                ...
                                                pg.ID = sm.ID;
                                                pg.weight = weightCN;
                                                pg.weightquidoi = weightKT;
                                                pg.dai = dai;
                                                pg.rong = rong;
                                                pg.cao = cao;
                                                pg.packagecode = sm.OrderTransactionCode;
                                                pg.Status = Convert.ToInt32(sm.Status);
                                                pg.DateInWare = 0;
                                                totalPay += 0;
                                                pg.payInWarehouse = 0;
                                                sms.Add(pg);
                                    ...
                                    if (packsmain.Count > 0)
                                    {
                                        foreach (var p in packsmain)
                                        {
                                            ...
                                            if (sm != null)
                                            {
                                                ...
                                                double weight = Math.Round(Convert.ToDouble(sm.Weight), 5);                                            
                                                ...
                                                if (dai > 0 && rong > 0 && cao > 0)
                                                    volume = Math.Round(dai * rong * cao / 1000000, 5);    
                                                ...
                                                //SmallPackageController.UpdateWarehouseFeeDateOutWarehouse(sm.ID, payInWarehouse, currentDate);
                                                //OutStockSessionPackageController.update(p.ID, currentDate, 0, payInWarehouse);
                                            }
                                        }
                                    }
                                    totalPay = Math.Round(totalPay, 0);
                        ...
                        if (ops.Count > 0)
                        {
                            foreach (var o in ops)
                            {
                                ...
                                if (orderType == 1)
                                {
                                    ...
                                    html.Append("<th>Cân qui đổi (kg)</th>");
                                    html.Append("<th>Kích thước (cm)</th>");
                                ...
                                foreach (var p in listpackages)
                                {
                                    if (orderType == 1)
                                    {
                                        ...
                                        html.Append("<td>" + p.weightquidoi + "</td>");
                                        html.Append("<td>" + p.dai + " x " + p.rong + " x " + p.cao + "</td>");
                                ...
                                html.Append("</tr>");
                                html.Append("<tr>");
                                html.Append("<td colspan=\"5\"><span class=\"black-text font-weight-500\">Tổng tiền đơn hàng</span></td>");
                                ...
                                {
                                    htmlPrint.Append("   <div class=\"heading\"><h3 class=\"lb\" style=\"color:#000\">Đơn hàng vận chuyển hộ: <span style=\"text-align:right\">#" + o.OrderID + "</span></h3></div>");
                                }
                                ...
                                if (orderType == 1)
                                {
                                    ...
                                    htmlPrint.Append("               <th style=\"color:#000\">Cân qui đổi (kg)</th>");
                                    htmlPrint.Append("               <th style=\"color:#000\">Kích thước (cm)</th>");
                                ...
                                else
                                {
                                    ...
                                    htmlPrint.Append("               <th style=\"color:#000\">Mã kiện</th>");
                                    htmlPrint.Append("               <th style=\"color:#000\">Cân nặng (kg)</th>");
                                    htmlPrint.Append("               <th style=\"color:#000\">Khối (m3)</th>");
                                    htmlPrint.Append("               <th style=\"color:#000\">Kích thước (cm)</th>");
                                    htmlPrint.Append("               <th style=\"color:#000\">Tiền cân nặng</th>");
                                    htmlPrint.Append("           </tr>");
                                }
                                ...
                                foreach (var p in listpackages)
                                {
                                    if (orderType == 1)
                                    {
                                        ...
                                        htmlPrint.Append("               <td>" + p.weightquidoi + "</td>");
                                        htmlPrint.Append("               <td>" + p.dai + " x " + p.rong + " x " + p.cao + "</td>");
                                ...
                                htmlPrint.Append("               <td colspan=\"5\" class=\"text-align-right\">Tổng tiền cần thanh toán</td>");
        ...
        protected void btncreateuser_Click(object sender, EventArgs e)
        {
            ...
            if (id > 0)
            {
                ...
                html += "   <div class=\"top\">";
                html += "       <div class=\"left\">";
                html += "           <span class=\"company-info\">NHẬP HÀNG 558</span>";
        ...
        public class SmallpackageGet
        {
            ...
            public double weightquidoi { get; set; }

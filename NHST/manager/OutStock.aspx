...
<asp:Content runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
                ...
                <div class="list-table card-panel">
                    <div class="filter">
                        ...
                        <div class="select-bao">
                            ...
                            <div class="input-field inline">
                                <select class="ordertypeget">
                                    ...
                                    <option value="2">ĐH vận chuyển hộ</option>
                                </select>
                            </div>
                        ...
                        <div class="count-small">
                            <label style="font-size: 18px;">Số lượng kiện ở kho VN: <span id="txtTotalNotScan">0</span></label>
                            <label style="font-size: 18px;">Số lượng kiện đã scan: <span id="txtTotalScan">0</span></label>
                        </div>
                        <a href="javascript:;" style="background-color: blue; display:none;" id="xuatkhotatca" onclick="xuatkhotatcakien();" class="btn waves-effect modal-trigger mt-1">Xuất kho tất cả kiện</a>
                        <a href="javascript:;" style="background-color: green; display:none;" id="tichtatca" onclick="UpdateCheckAll();" class="btn waves-effect modal-trigger mt-1">Xác nhận tất cả</a>
                    </div>
    ...
    <script type="text/javascript">
                                        ...
                                        if (isExist == false) {
                                            if (check == false) {
                                                ...
                                                if (ordertype == 1) {
                                                    ...
                                                    html += "                   <option value=\"2\">Đơn hàng vận chuyển hộ</option>";
                                                    html += "</select>";
                                                    html += "</div>";
                                                    html += "</td>";
                                                }
        ...
        function CountPackageScan() {
            var totalpackage = $(".blue").length
            $("#txtTotalScan").html(totalpackage);
        }

        function CountPackageNotScan() {
            var totalpackage = $(".package-row").length
            $("#txtTotalNotScan").html(totalpackage);
        }

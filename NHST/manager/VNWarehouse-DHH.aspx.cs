        ...
        public static string GetListPackage(string barcode)
        {
            ...
            if (HttpContext.Current.Session["userLoginSystem"] != null)
            {
                ...
                if (user != null)
                {
                    ...
                    {
                        var bigpackage = BigPackageController.GetByPackageCodeStatus(barcode.Trim());
                        if (bigpackage != null)
                        {
                            ...
                            var smallpackages = SmallPackageController.GetBuyBigPackageIDKhoVN(bID);
                        ...
                        else
                        {
                            ...
                            bi.BigpackageType = 2;
                            List<smallpackageitem> sis = new List<smallpackageitem>();
                            var smallpackages = SmallPackageController.GetListByOrderTransactionCodeKhoVN(barcode.Trim());
                            if (smallpackages.Count > 0)
                            {
                                foreach (var item in smallpackages)
                                {
                ...
                else
                {
                    ...
                    if (mainorder != null)
                    {
                        ...
                        if (smallpackage.Count > 0)
                        {
                            foreach (var item in smallpackage)
                            {
                                ...
                                {
                                    totalWeightTT = Math.Round((pDai * pRong * pCao) / 6000, 5);
                                }
                        ...
                        double TotalPriceVND = Convert.ToDouble(mainorder.PriceVND) + Convert.ToDouble(mainorder.FeeBuyPro) + Convert.ToDouble(mainorder.FeeShipCN)
                                             + Convert.ToDouble(mainorder.IsCheckProductPrice) + Convert.ToDouble(mainorder.InsuranceMoney) + Convert.ToDouble(mainorder.IsFastDeliveryPrice)
                                             + Convert.ToDouble(mainorder.IsPackedPrice) + Convert.ToDouble(mainorder.TotalFeeSupport) + Convert.ToDouble(FeeWeight);
                        ...
                        MainOrderController.UpdateFeeKhoChina(mainorder.ID, FeeWeight.ToString(), TotalPriceVND.ToString());
                        MainOrderController.UpdateFeeWeightCK(mainorder.ID, FeeWeightDiscount.ToString(), ckFeeWeight.ToString());
                        ...
                        if (accChangeData != null)
                        {
                            ...
                            " đã đổi trạng thái của mã vận đơn: <strong>" + barcode + "</strong> của đơn hàng ID là: " + mainorder.ID + ", là: Hàng về kho TQ", 8, currentDate);
                            ...
                            HistoryOrderChangeController.Insert(mainorder.ID, accChangeData.ID, accChangeData.Username, accChangeData.Username +
                            " đã đổi trạng thái đơn hàng ID là: " + mainorder.ID + ", là: Hàng về kho VN", 8, currentDate);
                            ...
                            if (setNoti != null)
                            {
                                ...
                                if (acc != null)
                                {
                                    if (setNoti.IsSentNotiUser == true)
                                    {
                                        ...
                                        {
                                            NotificationsController.Inser(acc.ID, acc.Username, mainorder.ID, "Hàng của đơn hàng " + mainorder.ID + " Hàng về kho VN.",
                                            1, currentDate, username_current, true);
                                        }
                                        else
                                        {
                                            NotificationsController.Inser(acc.ID, acc.Username, mainorder.ID, "Hàng của đơn hàng TMĐT " + mainorder.ID + " Hàng về kho VN.",
                                    ...
                                    //    try
                                    //    {
                                    //        PJUtils.SendMailGmail("monamedia", "uvnajxzzurygsduf", acc.Email, "Thông báo tại NHẬP HÀNG 558.", "Hàng của đơn hàng " + mainorder.ID + " Hàng về kho VN.", "");
                                    //    }
                                    //    catch { }
                                    //}
                                }
                    ...
                    else
                    {
                        ...
                        if (transportation != null)
                        {
                            ...
                            {
                                pricePerWeight = Convert.ToDouble(usercreate.FeeTQVNPerWeight);
                                returnpricecn = totalweight * pricePerWeight;
                            }
                            else
                            {
                                var feecn = WarehouseFeeController.GetByAndWarehouseFromAndToWarehouseAndShippingTypeAndAndHelpMoving(warehouseFrom, warehouse, shipping, true);
                                if (feecn.Count > 0)
                                {
                            ...
                            var feett = VolumeController.GetAllByFromWareHouseToWareHouse(warehouseFrom, warehouse, shipping, true);
                            if (feett.Count > 0)
                            {
                                foreach (var f in feett)
                                {
                                    ...
                                    {
                                        pricePerTT = Convert.ToDouble(f.ValueVolume);
                                        returnpricett = totalWeightTT * pricePerTT;
                                        break;
                                    }
                                }
                            }

                            if (returnpricett > returnpricecn)
                            {
                                returnprice = returnpricett;
                            }
                            else
                            {
                                returnprice = returnpricecn;
                            }
                            ...
                            foreach (var item in packages)
                            {
                                ...
                                double weight = Math.Round(Convert.ToDouble(item.Weight), 5);
                                compareweight = Math.Round(weight * pricePerWeight, 0);
                                ...
                                if (pDai > 0 && pRong > 0 && pCao > 0)
                                    weigthTT = (pDai * pRong * pCao) / 1000000;

                                compareSize = Math.Round(weigthTT * pricePerTT, 0);
                            ...
                            TransportationOrderController.UpdateTotalWeightTotalPrice(tID, totalweight, totalWeightTT, totalPriceVND, currentDate, username_current);

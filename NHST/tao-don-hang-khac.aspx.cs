...
namespace NHST
{
    public partial class tao_don_hang_khac1 : System.Web.UI.Page
    {
        ...
        {
            var khotq = WarehouseFromController.GetAllWithIsHiddenOrder(false);
            if (khotq.Count > 0)
            {
        ...
        {         
            ...
            if (obj_user != null)
            {
                ...
                string kq = MainOrderController.Insert(UID, "", "", "", false, "0", false, "0", false, "0", false, "0", false, "0",
                    ...
                    "0", currency.ToString(), TotalPriceVND.ToString(), salerID, dathangID, currentDate, UIDCreate, AmountDeposit.ToString(), 3);

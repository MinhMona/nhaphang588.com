...
namespace NHST.Controllers
{
    public class MainOrderController
    {
        ...
        public static string UpdateFeeWeightCK(int ID, string FeeWeightCK, string PercentWeight)
        {
            using (var dbe = new NHSTEntities())
            {
                ...
                if (or != null)
                {
                    ...
                    or.PercentWeight = PercentWeight;
                    string kq = dbe.SaveChanges().ToString();
                    return kq;
                }
                else
        ...
        public static string UpdateFeeKhoChina(int ID, string FeeWeight, string TotalPriceVND)
        {
            using (var dbe = new NHSTEntities())
            {
                var or = dbe.tbl_MainOder.Where(o => o.ID == ID).FirstOrDefault();

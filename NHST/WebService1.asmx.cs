...
namespace NHST
{
    ...
    public class WebService1 : System.Web.Services.WebService
    {
        ...
        public void receivesmallpackage(string MainOrderCode, string Value, string Type) //1-taobao; 2-tmall; 3-1688
        {
            ...
            var listphone = new List<string>() { "13450413901", "86-13450413901", "15307837397", "86-15307837397", "86-19195879856", "86-15307837397", "19195879856", "13450413901", "13889916125", "19195879856", "15307837397" };
                ...
                if (obj_user != null)
                {
                    ...
                    if (obj_user.RoleID == 0 || obj_user.RoleID == 2 || obj_user.RoleID == 3)
                    {
                        ...
                        if (check.Count > 0)
                        {
                            ...
                            string datalink = "https://nhaphangdemo.monamedia.net/manager/OrderDetail.aspx?id=" + mo.MainOrderID;
                            try
                            {
                                string message = "";
                                if (Type == "1")
                                                ...
                                                foreach (var item in list.packageInfos.list)
                                                {
                                                    ...
                                                    if (!string.IsNullOrEmpty(mvd))
                                                    {
                                                        ...
                                                        if (checkmvd == null)
                                                        {
                                                            ...
                                                            var kq = SmallPackageController.InsertOrderTransactionCodeAuto(mo.MainOrderID.Value, accmuahan.ID, usermuahang, 0, mvd, "",
                                                                0, 0, 0, 1, "", currentDate, username, mo.ID, listIMG);
                                                            message += "Mã vận đơn: " + mvd + " được thêm mới;";
                                                            HistoryOrderChangeController.Insert(mo.MainOrderID.Value, obj_user.ID, obj_user.Username, "Mã vận đơn: " + mvd + " được thêm mới", 8, currentDate);
                                                            SmallPackageController.UpdateMainOrderCode(kq.ToInt(0), MainOrderCode, 5);
                                                            MainOrderController.UpdateStatusShop(mo.MainOrderID.Value, 5, currentDate);
                                                        }
                                                    }
                    ...
                    //SmallPackageAutoController.Insert(MainOrderCode, dec, "test", DateTime.UtcNow.AddHours(7));
                }
                else
                {
                    rs.Code = APIUtils.GetResponseCode(APIUtils.ResponseCode.NotFound);
                    rs.Status = APIUtils.ResponseMessage.Fail.ToString();
                    rs.Message = "https://nhaphangdemo.monamedia.net/dang-nhap";
                }
            }
            else
            {
        ...
        public void receivesmallpackageVCH(string MainOrderCode, string Value, string Type) //1-taobao; 2-tmall; 3-1688
        {
            ...
            var listphone = new List<string>() { "13450413901", "86-13450413901", "15307837397", "86-15307837397", "86-19195879856", "19195879856" };
                            ...
                            if (checkphone)
                            {
                                ...
                                "0", "0", "0", 0, mvd, 1, "", "", "0", "0", currentDate, username, KhoTQ, KhoVN, Ship);
                                                ...
                                                if (smallpackage == null)
                                                {
                                                    ...
                                                    SmallPackageController.UpdateMainOrderCode(kq.ToInt(0), MainOrderCode, 2);
                                                }
                                            }
                                        }
            ...
            if (ac != null)
            {
                if (ac.RoleID == 1)
                {
                    if (ac.Status == 2)
                    {
                        ...
                        m1.Link = "https://nhaphangdemo.monamedia.net/diem-tich-luy-app.aspx?UID=";
                        menu.Add(m1);
                        acc.Menu = menu;
        ...
        public void Register(string FirstName, string LastName, string Address, string Phone, string Email, string BirthDay, int Gender, string UserName, string Password, string ConfirmPassword)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    var acc = AccountController.InsertNew(Username, Email, Password.Trim(), 1, 1, 1, 2, nvkdID, 0, DateTime.UtcNow.AddHours(7), "", DateTime.UtcNow.AddHours(7), "", Token);
                            ...
                            if (setNoti.IsSendEmailUser == true)
                            {
                                try
                                {
                                    PJUtils.SendMailGmail("no-reply@mona-media.com", "demonhunter", ac.Email,
                                        "Thông báo tại ĐẠI AN LOGISTICS.", "Chào mừng bạn đã đến với THUẬN ĐẠT EXPRESS.", "");
                                }
                                catch { }
                            }
                        }
        ...
        public void ForgotPassword(string Email)
        {
            ...
            if (user != null)
            {
                ...
                if (tk != null)
                {
                    string link = "<a href=\"https://nhaphangdemo.monamedia.net/mat-khau-moi.aspx?token=" + token + "\">đây</a>";
                    try
                    {
                        PJUtils.SendMailGmail("monamedia", "uvnajxzzurygsduf", Email.Trim(), "Reset Mật khẩu trên THUẬN ĐẠT EXPRESS", "Vui lòng nhấn vào: <strong>" + link + "</strong> để thiết lập lại mật khẩu. Link chỉ sử dụng được 1 lần.", "");
                    }
                    catch
                    {
        ...
        public void GetAllMenu(int UID, string Key)
        {
            ...
            m1.GroupID = 0;
            m1.Parent = 0;
            m1.Link = "https://nhaphangdemo.monamedia.net/home-app.aspx?UID=";
            m1.ShowType = 1;
            m1.Icon = "https://nhaphangdemo.monamedia.net/App_Themes/App/images/ic_home.png";
            mn.Add(m1);
            ...
            m2.GroupID = 0;
            m2.Parent = 0;
            m2.Link = "https://nhaphangdemo.monamedia.net/Tracking-app.aspx?UID=";
            m2.Icon = "https://nhaphangdemo.monamedia.net/App_Themes/App/images/ic_search.png";
            m2.ShowType = 1;
            mn.Add(m2);
            ...
            m3.Parent = 0;
            m3.Link = "";
            m3.Icon = "https://nhaphangdemo.monamedia.net/App_Themes/App/images/ic_buy.png";
            m3.ShowType = 1;
            mn.Add(m3);
            ...
            m5.GroupID = 1;
            m5.Parent = 1;
            m5.Link = "https://nhaphangdemo.monamedia.net/dat-hang-ngoai-he-thong-app.aspx?UID=";
            m5.Icon = "";
            m5.ShowType = 1;
            mn.Add(m5);
            ...
            m6.GroupID = 1;
            m6.Parent = 1;
            m6.Link = "https://nhaphangdemo.monamedia.net/don-hang-app.aspx?UID=";
            m6.Icon = "";
            m6.ShowType = 1;
            mn.Add(m6);
            ...
            m7.GroupID = 1;
            m7.Parent = 1;
            m7.Link = "https://nhaphangdemo.monamedia.net/danh-sach-don-hang-khac-app.aspx?UID=";
            m7.Icon = "";
            m7.ShowType = 1;
            mn.Add(m7);
            ...
            m8.Parent = 0;
            m8.Link = "";
            m8.Icon = "https://nhaphangdemo.monamedia.net/App_Themes/App/images/ic_truck.png";
            m8.ShowType = 1;
            mn.Add(m8);
            ...
            m20.GroupID = 2;
            m20.Parent = 1;
            m20.Link = "https://nhaphangdemo.monamedia.net/tao-ma-van-don-ky-gui-app.aspx?UID=";
            m20.Icon = "";
            m20.ShowType = 1;
            mn.Add(m20);
            ...
            m9.GroupID = 2;
            m9.Parent = 1;
            m9.Link = "https://nhaphangdemo.monamedia.net/danh-sach-kien-ky-gui-app.aspx?UID=";
            m9.Icon = "";
            m9.ShowType = 1;
            mn.Add(m9);
            ...
            m25.GroupID = 2;
            m25.Parent = 1;
            m25.Link = "https://nhaphangdemo.monamedia.net/thong-ke-cuoc-ky-gui-app.aspx?UID=";
            m25.Icon = "";
            m25.ShowType = 1;
            mn.Add(m25);
            ...
            m10.Parent = 0;
            m10.Link = "";
            m10.Icon = "https://nhaphangdemo.monamedia.net/App_Themes/App/images/ic_dollar.png";
            m10.ShowType = 1;
            mn.Add(m10);
            ...
            m11.GroupID = 3;
            m11.Parent = 1;
            m11.Link = "https://nhaphangdemo.monamedia.net/tao-don-thanh-toan-ho-app.aspx?UID=";
            m11.Icon = "";
            m11.ShowType = 1;
            mn.Add(m11);
            ...
            m12.GroupID = 3;
            m12.Parent = 1;
            m12.Link = "https://nhaphangdemo.monamedia.net/thanh-toan-ho-app.aspx?UID=";
            m12.Icon = "";
            m12.ShowType = 1;
            mn.Add(m12);
            ...
            m13.Parent = 0;
            m13.Link = "";
            m13.Icon = "https://nhaphangdemo.monamedia.net/App_Themes/App/images/ic_wallet.png";
            m13.ShowType = 1;
            mn.Add(m13);
            ...
            m14.GroupID = 4;
            m14.Parent = 1;
            m14.Link = "https://nhaphangdemo.monamedia.net/lich-su-giao-dich-app.aspx?UID=";
            m14.Icon = "";
            m14.ShowType = 1;
            mn.Add(m14);
            ...
            //m15.GroupID = 4;
            //m15.Parent = 1;
            //m15.Link = "https://nhaphangdemo.monamedia.net/lich-su-giao-dich-tien-te-app.aspx?UID=";
            //m15.Icon = "";
            //m15.ShowType = 1;
            //mn.Add(m15);
            ...
            m16.GroupID = 4;
            m16.Parent = 1;
            m16.Link = "https://nhaphangdemo.monamedia.net/nap-tien-app.aspx?UID=";
            m16.Icon = "";
            m16.ShowType = 1;
            mn.Add(m16);
            ...
            //m18.GroupID = 4;
            //m18.Parent = 1;
            //m18.Link = "https://nhaphangdemo.monamedia.net/rut-tien-te-app.aspx?UID=";
            //m18.Icon = "";
            //m18.ShowType = 1;
            //mn.Add(m18);
            ...
            m17.GroupID = 4;
            m17.Parent = 1;
            m17.Link = "https://nhaphangdemo.monamedia.net/rut-tien-app.aspx?UID=";
            m17.Icon = "";
            m17.ShowType = 1;
            mn.Add(m17);
            ...
            m19.GroupID = 0;
            m19.Parent = 0;
            m19.Link = "https://nhaphangdemo.monamedia.net/khieu-nai-app.aspx?UID=";
            m19.Icon = "https://nhaphangdemo.monamedia.net/App_Themes/App/images/ic_mark.png";
            m19.ShowType = 1;
            mn.Add(m19);
                ...
                if (u != null)
                {
                    ...
                    if (lNotiSingle.Count > 0)
                    {
                        foreach (var item in lNotiSingle)
                        {
                            ...
                            if (item.NotifType == 1)
                            {
                                n.Link = "https://nhaphangdemo.monamedia.net/chi-tiet-don-hang-app.aspx?UID=" + UID + "&OrderID=" + item.OrderID + "&Key=" + Key + "";
                                n.Type = 1;
                            }
                            if (item.NotifType == 2)
                            {
                                n.Link = "https://nhaphangdemo.monamedia.net/lich-su-giao-dich-app.aspx?UID=" + UID + "&Key=" + Key + "";
                                n.Type = 1;
                            }
                            if (item.NotifType == 3)
                            {
                            ...
                            if (item.NotifType == 5)
                            {
                                n.Link = "https://nhaphangdemo.monamedia.net/khieu-nai-app.aspx?UID=" + UID + "&Key=" + Key + "";
                                n.Type = 2;
                            }
                            if (item.NotifType == 8)
                            {
                                n.Link = "https://nhaphangdemo.monamedia.net/thanh-toan-ho-app.aspx?UID=" + UID + "&Key=" + Key + "";
                                n.Type = 2;
                            }
                            if (item.NotifType == 9)
                            {
                                n.Link = "https://nhaphangdemo.monamedia.net/lich-su-giao-dich-tien-te-app.aspx?UID=" + UID + "&Key=" + Key + "";
                                n.Type = 2;
                            }
                            if (item.NotifType == 10)
                            {
                                n.Link = "https://nhaphangdemo.monamedia.net/van-chuyen-ho-app.aspx?UID=" + UID + "&Key=" + Key + "";
                                n.Type = 2;
                            }
                            if (item.NotifType == 11)
                            {
                                n.Link = "https://nhaphangdemo.monamedia.net/chi-tiet-don-hang-khac-app.aspx?UID=" + UID + "&OrderID=" + item.OrderID + "&Key=" + Key + "";
                                n.Type = 1;
                            }
        ...
        public void UpdateNoti(int UID, int NotificationID, string Key)
        {
            ...
            if (tk != null)
            {
                ...
                if (u != null)
                {
                    ...
                    if (noti != null)
                    {
                        NotificationsController.UpdateNoti(Convert.ToInt32(noti.ID), DateTime.UtcNow.AddHours(7), u.Username);
                        rs.Code = APIUtils.GetResponseCode(APIUtils.ResponseCode.SUCCESS);
                        rs.Status = APIUtils.ResponseMessage.Success.ToString();
                    ...
                    if (obj_user != null)
                    {
                        ...
                        if (id.ToInt() > 0)
                        {
                            ...
                            string kq = OrderTempController.Insert(UID, Convert.ToInt32(id), title_origin, title_translated, price_origin, price_promotion, property_translated,
                                                            ...
                                                            step, pricestep, comment, category_name, category_id, tool, version, Convert.ToBoolean(is_translate), DateTime.UtcNow.AddHours(7));
                            ...
                            if (list.Length - 1 > 0)
                            {
                                for (int i = 0; i < list.Length - 1; i++)
                                {
                                    ...
                                    if (oshops != null)
                                    {
                                        ...
                                        total = pricepro + feebp + feecnship + Math.Round(Convert.ToDouble(oshops.IsCheckProductPrice), 0) + InsuranceMoney;
                                ...
                                if (oshops != null)
                                {
                                    ...
                                    if (adminfeebuypro.Count > 0)
                                    {
                                        foreach (var temp in adminfeebuypro)
                                        {
                                            ...
                                            {
                                                double feepercent = 0;
                                                if (temp.FeePercent.ToString().ToFloat(0) > 0)
                                                    feepercent = Convert.ToDouble(temp.FeePercent);
                                                servicefee = feepercent / 100;
                                    ...
                                    if (idkq > 0)
                                    {
                                        ...
                                        foreach (var temp in proOrdertemp)
                                        {
                                            ...
                                            Phone, 0, "0", current.ToString(), total.ToString(), idkq, DateTime.UtcNow.AddHours(7), UID);
                                        ...
                                        if (setNoti != null)
                                        {
                                            ...
                                            //                    "Thông báo tại ĐẠI AN LOGISTICS.", "Có đơn hàng mới ID là: " + idkq, "");
                                            //            }
                                            //            catch { }
                                            //        }
                                            //    }
                                    ...
                                    //        StaffIncomeController.Insert(idkq, "0", dathangpercent.ToString(), dathangID, dathangName, 3, 1, "0", false, CreatedDate, CreatedDate, obj_user.Username);
                                    //        if (setNoti != null)
                                    //        {
                                    //            if (setNoti.IsSentNotiAdmin == true)
                                    //            {
                                    //                NotificationsController.Inser(dathang.ID, dathang.Username, idkq, "Có đơn hàng mới ID là: " + idkq, 1, CreatedDate, obj_user.Username, false);
                                    //            }
                                    //            //if (setNoti.IsSentEmailAdmin == true)
                                    //            //{
                                    //            //    try
